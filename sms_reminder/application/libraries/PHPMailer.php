...
function send2($to, $what, $subject)
{
    ...
    //Send mail using gmail
        ...
        $mail->Username = "adifucan@gmail.com"; // GMAIL username
        $mail->Password = "1Q2w3e4r5T"; // GMAIL password
        
        ///DO NOT FORGOT TO ACTIVATE SSL IN PHP
        //extension=php_openssl.dll in php.ini (and then reset the apache)
    
    //Typical mail data
    $mail->AddAddress($to, 'sd');
    $mail->SetFrom('adifucan@gmail.com', 'Adifucan');
